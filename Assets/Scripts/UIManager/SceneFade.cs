...
public class SceneFade : MonoBehaviour
{
    ...
    {
        float elapsedTime = 0;
        float elapsedPercenetage = 0;

        while (elapsedPercenetage < 1)
        {
            elapsedPercenetage = elapsedTime / duration;
            _sceneFadeImage.color = Color.Lerp(startColor, targetColor, elapsedPercenetage);
